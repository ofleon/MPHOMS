...
{
    public partial class oleon134_MHCommerceContext : DbContext
    {
        public oleon134_MHCommerceContext()
        {
        }

        public oleon134_MHCommerceContext(DbContextOptions<oleon134_MHCommerceContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=52.117.175.212,782;Database=oleon134_MHCommerce;Trusted_Connection=False;User ID=oleon134_mipeqhdev;Password=TacosGobernador20");
            }
        }
