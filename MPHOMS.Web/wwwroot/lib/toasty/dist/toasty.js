...
;(function () {
    ...
    var _defaults = {
        ...
        sounds: {
            ...
            info: "../lib/toasty/dist/sounds/info/1.mp3",
            // path to sound for successfull message:
            success: "../lib/toasty/dist/sounds/success/1.mp3",
            // path to sound for warn message:
            warning: "../lib/toasty/dist/sounds/warning/1.mp3",
            // path to sound for error message:
            error: "../lib/toasty/dist/sounds/error/1.mp3",
        },
